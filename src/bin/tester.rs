...
fn main() {
    ...
    match exec(&mut p) {
        Ok(outcome) => {
            eprintln!("Score = {}", format_with_commas(outcome.score));
            eprintln!("Number of wrong answers = {}", format_with_commas(outcome.wrong_answer));
            eprintln!("Placement cost = {}", format_with_commas(outcome.arrange_cost));
            eprintln!("Measurement cost = {}", format_with_commas(outcome.measure_cost));
            eprintln!("Measurement count = {}", format_with_commas(outcome.measure_cnt));
